...
```bash
<<<<<<< HEAD
claude mcp add-json <your-config-id> '{"command":"npx","args":["-y","@fluxa-pay/fluxa-connect-mcp","--url","https://fluxa-servers-connection.up.railway.app/mcp/<your-config-id>"],"env":{"AGENT_EMAIL":"your@email.com","AGENT_NAME":"Claude Code - agentwallet.fluxapay.xyz","CLIENT_INFO":"Claude Code on macOS"}}'
=======
claude mcp add-json 038f5ec7-8307-4fae-bca7-79b18a640095 '{"command":"npx","args":["-y","@fluxa-pay/fluxa-connect-mcp","--url","https://fluxa-servers-connection.up.railway.app/mcp/<your-config-id>"],"env":{"AGENT_EMAIL":"your@email.com","AGENT_NAME":"Claude Code - agentwallet.fluxapay.xyz","CLIENT_INFO":"Claude Code on macOS"}}'
>>>>>>> main
```
